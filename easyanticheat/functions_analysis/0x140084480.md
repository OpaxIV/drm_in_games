...
Finally there is an usual beviour: Instead of returning or at least jumping to another address, the function takes a `140556894  jmp     rcx`. This is quite unusual, since normally a jump to an address or `jmp *%reg` (dereference register and jump to address) would be more usual.
<br>
@tim
