...
This is quite unusual, since normally a jump to an address or `jmp *%reg` (dereference register and jump to address) would be more usual. This could be a hint of this function being part of a broader picture, maybe being a handler which is jumped from and to.
<br>
