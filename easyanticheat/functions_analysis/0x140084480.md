...
<br>
<img src="https://github.com/OpaxIV/hslu_secproj/assets/93701325/20e24c5e-efc7-4264-a238-b633a2bc8f9f" width="500">
<br/>
...
@fabio: incorporate strange instructions and jumps etc. into the individual parts of the control flow, large values maybe also?
...
```
<br>
Furthermore, we can see some unusual instructions being used like for example `cvtsi2sd` and `xorps`
