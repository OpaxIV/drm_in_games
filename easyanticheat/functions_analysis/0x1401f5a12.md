...
<br>
When going further, we can see that the very same variables is also used in the context of
```
[...]
9 @ 1401f5a90  int128_t zmm10;
10 @ 1401f5a90  zmm10 = (zmm9 * zmm9);
...
**This encapsulation of expressions would lead to the assumption of the code being of the type of Arithmetic Encoding.**
