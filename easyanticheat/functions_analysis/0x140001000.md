...
- 1152920920491294759 ?? // auslassen, egal einfach in hex umwandeln und 1 zahl als beispiel
- "byte_14007B170", was ist das? bytearray? ---> cmp bytearray, dil
- bspw. 000000014000106B: zahlen in int
- rep stosb

- oft keys für weitere verwundeung, grosse zahlen/values .. grössere dateunstruktur
32bit werte werden reingeladen, struct, array .. stack 32 bit value offsets immer
hex werte ändern
