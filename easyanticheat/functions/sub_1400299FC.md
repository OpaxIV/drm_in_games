...
[...]
```
On the other hand, if the "false" case is executed, then in the next basic block the value of `r8` is modified by an `and     r8, 7Fh` operation. Either way both of these paths lead to the basic block at `0x140058781`.
